        ...
        <class="card card-info mt-3">
            ...
            <div class=" card-body">
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input type="text" name="nama_file" id="nama_file" class="form-control"
                            placeholder="Nama File Awal" value="<?=$data['nama_file'];?>" readonly>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input type="text" name="nama_file_enkrip" id="nama_file_enkrip" class="form-control"
                            placeholder="Nama File Enkripsi" value="<?=$data['nama_file_enkrip'];?>" readonly>
